<%-- 
    Document   : restrita
    Created on : 23/09/2020, 23:23:21
    Author     : Felipe
--%>
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="textoNavbar">
              ...
              <span class="navbar-text">
                ...
                <a class="btn btn-dark" href="sair.jsp" style="color: white;">Sair</a>
              </span>
            </div>
        </nav>
        <div class="container">
            <h1>página restrita do FBI</h1>
            
            <div class="row mt-4 mb-4">
                <button class="btn-dark" data-toggle="modal" data-target="#modalExemplo">Novo Usuário</button> &nbsp; &nbsp; &nbsp; &nbsp;
    ...
    <div class="modal-content">
      ...
      <form action="restrita.jsp" method="post" class="form" id="cadastro">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" name="btn-salvar" class="btn btn-dark">Cadastrar</button>
        </div>
      </form>
    </div>
  </div>
...
<%
    ...
    if (request.getParameter("btn-salvar") != null) {
            ...
            String Cnivel = request.getParameter("nivel");
            
            try{
                
                st = new Conexao().conectar().createStatement();
                st.executeUpdate("INSERT INTO users (nome, email, senha, nivel) VALUES ('"+Cnome+"','"+Cemail+"','"+Csenha+"','"+Cnivel+"')");
